...
**Version: `0.1.7`** (up to ~55s exponential settle wait after clone before wipe/reclone)
...
|---------|---------|-------|
| `@rebornace/tracescope-core` | 0.1.7 | Analysis, storage, Yunxiao/tracker, export |
| `@rebornace/dsh-tracescope` | 0.1.7 | DSH Host + React Slot client |
| `@rebornace/tracescope-mcp` | 0.1.7 | MCP server |
